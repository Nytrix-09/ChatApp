...
//sets the environment for sender and receiver (chat environment)
public class ChatAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        //to delete message using alertDialog on Long pressing the Message
        ...
        if(holder.getClass()== SenderVH.class){
            ((SenderVH)holder).senderMsg.setText(messageModels.getMessage());
        }
        else{
            ((ReceiverVH)holder).receiverMsg.setText(messageModels.getMessage());
        }
    }
